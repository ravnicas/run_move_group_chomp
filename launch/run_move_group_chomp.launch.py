...
def generate_launch_description():
    ...
    # ompl_planning_pipeline_config["ompl-chomp"].update(ompl_planning_yaml)
    
    chomp_planning_pipeline_config = {"chomp": {}}
    chomp_planning_yaml = load_yaml(
        "run_move_group_chomp", "config/chomp_planning.yaml"
    )
    ...
    # RViz
    rviz_config_file = (
        get_package_share_directory("run_move_group_chomp") + "/launch/run_move_group_chomp.rviz"
    )
    rviz_node = Node(
        package="rviz2",
        executable="rviz2",
